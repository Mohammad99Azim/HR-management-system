...
/// all the above from the app.js file   i added cuse if we delete the data from the localStorage 
// we will  have some data in out table but when we add employee the code above will be useless
// check the if statment in getSomeData to understand 
